document.addEventListener('DOMContentLoaded', async function() {
    ...
    console.log(token);
    const response = await fetch('http://localhost:8088/customers/get', {
        headers: {
    ...
    // try {
    //     const response = await fetch('http://localhost:8088/api/verify-sync', {
    //         method: 'GET',
    //         headers: {
    //             'Authorization': 'Bearer ' + token
    //         }
...
async function syncCustomers() {
    ...
    try {
        const response = await fetch('http://localhost:8088/api/sync', {
            method: 'POST',
            headers: {
                'Authorization': 'Bearer ' + token
            }
...
async function fetchCustomers() {
    ...
    try {
        const response = await fetch('http://localhost:8088/api/customers/get', {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + token
            }
